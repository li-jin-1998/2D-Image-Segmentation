...
import logging
import argparse
from ShuffleNet.shufflenet import ShuffleNetV2
...
def get_args():
    ...
    parser.add_argument('--model-size', type=str, default='1.5x', choices=['0.5x', '1.0x', '1.5x', '2.0x'],
                        help='size of the model')

    parser.add_argument('--train-dir', type=str, default='data/train', help='path to training dataset')
    parser.add_argument('--val-dir', type=str, default='data/test', help='path to validation dataset')
...
def main():
    ...
    criterion_smooth = CrossEntropyLabelSmooth(2, 0.1)
